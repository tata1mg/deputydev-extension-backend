...
def mock_external_dependencies():
    ...
    with patch('deputydev_core.services.tiktoken.TikToken') as mock_tiktoken, \
         ...
         patch('app.main.blueprints.one_dev.services.repository.agent_chats.repository.AgentChatsRepository.get_chats_by_session_id') as mock_get_chats, \
         patch('app.main.blueprints.one_dev.services.repository.query_summaries.query_summary_dto.QuerySummarysRepository.get_query_summary') as mock_get_query_summary, \
         patch('app.main.blueprints.one_dev.services.repository.query_summaries.query_summary_dto.QuerySummarysRepository.update_query_summary') as mock_update_query_summary, \
         patch('app.main.blueprints.one_dev.services.repository.query_summaries.query_summary_dto.QuerySummarysRepository.create_query_summary') as mock_create_query_summary:
