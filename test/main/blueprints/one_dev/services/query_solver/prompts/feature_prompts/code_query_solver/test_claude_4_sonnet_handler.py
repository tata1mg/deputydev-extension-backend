...
class TestClaude4CodeQuerySolverPromptHandler:
    ...
    def test_get_parsed_response_blocks_with_claude_format(self) -> None:
        ...
        parsed_blocks, metadata = Claude4CodeQuerySolverPromptHandler.get_parsed_response_blocks(
            message_data
        )
    ...
    async def test_get_parsed_streaming_events(self) -> None:
        ...
        events = []
        async_iterator = await Claude4CodeQuerySolverPromptHandler.get_parsed_streaming_events(
