...
class TestToolRequestManager:
    ...
    async def test_process_tool_request_with_valid_tool(self) -> None:
        ...
        with patch.object(manager, '_tool_handlers', {
            'test_tool': AsyncMock(return_value=expected_response)
        }):
            # Act
    ...
    @patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_request_manager.format_comment_bucket_name')
