...
class TestToolHandlersRelatedCodeSearcher:
    ...
    async def test_handle_related_code_searcher_success(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.OneDevReviewClient') as mock_client_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.PRReviewEmbeddingManager') as mock_embedding_manager_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_weaviate_connection') as mock_weaviate, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.ReviewInitialisationManager') as mock_init_manager_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.RelevantChunks') as mock_relevant_chunks_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.ProcessPoolExecutor') as mock_executor_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.ConfigManager') as mock_config:
    ...
    async def test_handle_related_code_searcher_with_context_service(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context, \
             ...
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.PRReviewEmbeddingManager'), \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_weaviate_connection'), \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.ReviewInitialisationManager'), \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.RelevantChunks') as mock_relevant_chunks_class, \
...
class TestToolHandlersGrepSearch:
    ...
    async def test_handle_grep_search_success(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.GrepSearch') as mock_grep_search_class:
...
class TestToolHandlersIterativeFileReader:
    ...
    async def test_handle_iterative_file_reader_success(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.IterativeFileReader') as mock_reader_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.LLMResponseFormatter') as mock_formatter:
...
class TestToolHandlersFocusedSnippetsSearcher:
    ...
    async def test_handle_focused_snippets_searcher_success(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context, \
             ...
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.OneDevReviewClient') as mock_client_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.ReviewInitialisationManager') as mock_init_manager_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.FocussedSnippetSearch') as mock_search_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.ProcessPoolExecutor') as mock_executor_class, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.ConfigManager') as mock_config:
...
class TestToolHandlersFilePathSearcher:
    ...
    async def test_handle_file_path_searcher_success(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.FilePathSearch') as mock_search_class:
    ...
    async def test_handle_file_path_searcher_with_context_service(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context, \
            ...
            result = await ToolHandlers.handle_file_path_searcher(
                sample_file_path_search_input, sample_context_service
            )
...
class TestToolHandlersPrReviewPlanner:
    ...
    async def test_handle_pr_review_planner_success(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.ReviewPlanner') as mock_planner_class:
            ...
            result = await ToolHandlers.handle_pr_review_planner(
                sample_pr_review_planner_input, sample_context_service
            )
...
class TestToolHandlersPerformance:
    ...
    async def test_handle_multiple_tool_requests_concurrently(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context:
            ...
            tasks = [
                mock_parse_final_response(tool_input)
                for tool_input in sample_concurrent_tool_inputs
            ]
...
class TestToolHandlersIntegration:
    ...
    async def test_complete_tool_chain_workflow(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.get_context_value') as mock_get_context, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.FilePathSearch') as mock_file_search, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.IterativeFileReader') as mock_file_reader, \
             patch('app.main.blueprints.deputy_dev.services.code_review.common.tools.tool_handlers.LLMResponseFormatter') as mock_formatter:
            ...
            file_read_result = await ToolHandlers.handle_iterative_file_reader({
