...
class TestCommentBlendingEngine:
    ...
    @patch(
        "app.main.blueprints.deputy_dev.services.code_review.common.comments.comment_blending_engine.get_context_value"
    )
    ...
    @patch(
        "app.main.blueprints.deputy_dev.services.code_review.common.comments.comment_blending_engine.extract_line_number_from_llm_response"
    )
    ...
    @patch("app.main.blueprints.deputy_dev.services.code_review.common.comments.comment_blending_engine.AgentFactory")
    async def test_validate_comments_json_decode_error_retry(
        self, mock_agent_factory: Mock, mock_get_context_value: Mock
    ) -> None:
