...
class TestToolRequestManagerParseToolUseRequest:
    ...
    def test_parse_tool_use_request_no_parsed_content(
        self,
        mock_context_service: MagicMock,
        mock_llm_response_no_parsed_content: MagicMock
    ) -> None:
    ...
    def test_parse_tool_use_request_empty_parsed_content(
        self,
        mock_context_service: MagicMock,
        mock_llm_response_empty_parsed_content: MagicMock
    ) -> None:
    ...
    def test_parse_tool_use_request_without_parsed_content_attr(
        self,
        mock_context_service: MagicMock,
        mock_llm_response_without_parsed_content_attr: MagicMock
    ) -> None:
    ...
    def test_parse_tool_use_request_text_only_content(
        self,
        mock_context_service: MagicMock,
        mock_llm_response_with_text_only: MagicMock
    ) -> None:
    ...
    def test_parse_tool_use_request_invalid_tool_request_type(
        self,
        mock_context_service: MagicMock,
        mock_llm_response_with_invalid_tool_request: MagicMock
    ) -> None:
    ...
    def test_parse_tool_use_request_multiple_tools_returns_first_regular(
        self,
        mock_context_service: MagicMock,
        multiple_tool_requests_response: MagicMock
    ) -> None:
    ...
    def test_parse_tool_use_request_mixed_content(
        self,
        mock_context_service: MagicMock,
        mixed_content_response: MagicMock
    ) -> None:
...
class TestToolRequestManagerExtractFinalResponse:
    ...
    def test_extract_final_response_missing_comments_array(
        ...
        mock_llm_response_with_parse_final_response.parsed_content[0].content.tool_input = invalid_comments_tool_input_no_comments_array
    ...
    def test_extract_final_response_missing_required_field(
        ...
        # Update mock to have invalid tool input
        mock_llm_response_with_parse_final_response.parsed_content[0].content.tool_input = invalid_comments_tool_input_missing_field
    ...
    def test_extract_final_response_invalid_confidence_score_logs_warning(
        ...
        mock_llm_response_with_parse_final_response.parsed_content[0].content.tool_input = comments_tool_input_with_invalid_confidence_score
        
        with patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.tools.tool_request_manager.AppLogger.log_warn') as mock_log_warn:
            result = manager.extract_final_response(mock_llm_response_with_parse_final_response)
...
class TestToolRequestManagerProcessReviewPlannerResponse:
    ...
    async def test_process_review_planner_response_success(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.tools.tool_request_manager.ExtensionToolHandlers') as mock_handlers:
            mock_handlers.handle_pr_review_planner = AsyncMock(return_value=expected_review_plan_response)
            
            result = await manager.process_review_planner_response(
                mock_llm_response_with_pr_review_planner, 
                session_id
            )
    ...
    async def test_process_review_planner_response_not_planner_response(
        ...
        result = await manager.process_review_planner_response(
            mock_llm_response_with_tool_use, 
            session_id
        )
    ...
    async def test_process_review_planner_response_no_parsed_content(
        ...
        result = await manager.process_review_planner_response(
            mock_llm_response_no_parsed_content, 
            session_id
        )
...
class TestToolRequestManagerPrivateParseCommentsFromToolInput:
    ...
    def test_parse_comments_from_tool_input_handles_none_corrective_code(
        self,
        mock_context_service: MagicMock
    ) -> None:
    ...
    def test_parse_comments_from_tool_input_formats_code_blocks(
        self,
        mock_context_service: MagicMock
    ) -> None:
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.tools.tool_request_manager.format_code_blocks') as mock_format:
    ...
    def test_parse_comments_from_tool_input_formats_bucket_name(
        self,
        mock_context_service: MagicMock
    ) -> None:
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.tools.tool_request_manager.format_comment_bucket_name') as mock_format:
...
class TestToolRequestManagerEdgeCases:
    ...
    def test_manager_handles_missing_attributes_gracefully(
        self,
        mock_context_service: MagicMock
    ) -> None:
    ...
    def test_manager_handles_empty_tool_input(
        self,
        mock_context_service: MagicMock
    ) -> None:
    ...
    def test_manager_handles_none_values_in_comments(
        self,
        mock_context_service: MagicMock
    ) -> None:
