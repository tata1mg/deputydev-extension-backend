...
class TestPostProcessWebSocketManager:
    ...
    @pytest.mark.asyncio
    @patch(
        "app.main.blueprints.deputy_dev.services.code_review.ide_review.post_proces_web_socket_manager.IdeReviewPostProcessor"
    )
    ...
    async def test_process_request_without_user_team_id(self) -> None:
        ...
        with patch(
            ...
            # Assert
            mock_processor_instance.post_process_pr.assert_called_once_with(request_data, user_team_id=None)
