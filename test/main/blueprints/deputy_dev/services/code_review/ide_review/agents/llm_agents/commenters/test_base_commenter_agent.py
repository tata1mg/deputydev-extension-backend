...
class TestBaseCommenterAgentInitialization:
    ...
    def test_init_with_default_display_name(
        ...
        mock_context_service: MagicMock,
        mock_llm_handler: MagicMock,
        user_agent_dto_no_display_name: UserAgentDTO
    ) -> None:
...
class TestBaseCommenterAgentAgentRelevantChunk:
    ...
    def test_agent_relevant_chunk_success(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.render_snippet_array') as mock_render:
...
class TestBaseCommenterAgentRequiredPromptVariables:
    ...
    async def test_required_prompt_variables_empty_agent_setting(
        ...
        mock_context_service: MagicMock,
        mock_llm_handler: MagicMock,
        user_agent_dto_minimal: UserAgentDTO
    ) -> None:
...
class TestBaseCommenterAgentGetToolsForReview:
    ...
    def test_get_tools_for_review_tools_disabled(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.PARSE_FINAL_RESPONSE') as mock_final_response:
...
class TestBaseCommenterAgentRunAgent:
    ...
    async def test_run_agent_query_request_success(
        ...
        with patch.object(agent, '_handle_query_request', return_value=expected_result) as mock_handle_query, \
             patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.ReviewAgentChatsRepository') as mock_repo:
    ...
    async def test_run_agent_tool_use_response_request(
        ...
        with patch.object(agent, '_handle_tool_use_response', return_value=expected_result) as mock_handle_tool, \
             patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.ReviewAgentChatsRepository') as mock_repo:
    ...
    async def test_run_agent_invalid_request_type(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.ReviewAgentChatsRepository') as mock_repo:
            mock_repo.get_chats_by_agent_id_and_session = AsyncMock(return_value=[])
    ...
    async def test_run_agent_with_existing_chats(
        ...
        with patch.object(agent, '_handle_query_request', return_value=expected_result), \
             patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.ReviewAgentChatsRepository') as mock_repo:
...
class TestBaseCommenterAgentHandleQueryRequest:
    ...
    async def test_handle_query_request_success(
        ...
        with patch.object(agent, '_process_llm_response', return_value=expected_result) as mock_process, \
             patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.ReviewAgentChatsRepository') as mock_repo:
...
class TestBaseCommenterAgentProcessLLMResponse:
    ...
    async def test_process_llm_response_final_response_success(
        ...
        with patch.object(agent.tool_request_manager, 'is_final_response', return_value=True), \
    ...
    async def test_process_llm_response_final_response_error(
        ...
        with patch.object(agent.tool_request_manager, 'is_final_response', return_value=True), \
             patch.object(agent.tool_request_manager, 'extract_final_response', side_effect=Exception("Processing error")), \
             patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.AppLogger'):
    ...
    async def test_process_llm_response_tool_request(
        ...
        with patch.object(agent.tool_request_manager, 'is_final_response', return_value=False), \
...
class TestBaseCommenterAgentSaveCommentsToDb:
    ...
    async def test_save_comments_to_db_success(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.IdeCommentRepository') as mock_repo:
...
class TestBaseCommenterAgentIntegration:
    ...
    async def test_full_commenter_workflow_query_to_final_response(
        ...
        with patch.object(agent.tool_request_manager, 'is_final_response', return_value=True), \
             patch.object(agent.tool_request_manager, 'extract_final_response', return_value=sample_final_response_with_comments), \
             patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.ReviewAgentChatsRepository') as mock_chat_repo, \
             patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.IdeCommentRepository') as mock_comment_repo:
    ...
    async def test_full_commenter_workflow_with_tool_interaction(
        ...
        with patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.agents.llm_agents.commenters.base_commentor.ReviewAgentChatsRepository') as mock_chat_repo:
