...
class TestIdeReviewContextService:
    ...
    @pytest.mark.asyncio
    @patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.context.ide_review_context_service.IdeReviewCache')
    ...
    @pytest.mark.asyncio
    @patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.context.ide_review_context_service.append_line_numbers')
    @patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.context.ide_review_context_service.IdeReviewCache')
    async def test_get_pr_diff_success_with_line_numbers(self, mock_cache: Mock, mock_append_line_numbers: Mock) -> None:
    ...
    @patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.context.ide_review_context_service.append_line_numbers')
    @patch('app.main.blueprints.deputy_dev.services.code_review.ide_review.context.ide_review_context_service.IdeReviewCache')
    async def test_get_pr_diff_append_line_numbers_called_conditionally(self, mock_cache: Mock, mock_append_line_numbers: Mock) -> None:
