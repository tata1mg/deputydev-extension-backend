...
class TestGoogleUnifiedConversationTurns:
    ...
    async def test_get_google_content_from_user_text_turn(
        ...
        result = google_provider._get_google_content_from_user_conversation_turn(user_text_conversation_turn)
    ...
    async def test_get_google_content_from_user_multimodal_turn(
        ...
        result = google_provider._get_google_content_from_user_conversation_turn(user_multimodal_conversation_turn)
    ...
    async def test_get_google_content_from_assistant_text_turn(
        ...
        result = google_provider._get_google_content_from_assistant_conversation_turn(assistant_text_conversation_turn)
    ...
    async def test_get_google_content_from_assistant_with_tool_request(
        ...
        result = google_provider._get_google_content_from_assistant_conversation_turn(assistant_with_tool_request_turn)
    ...
    async def test_get_google_content_from_assistant_multiple_tools(
        ...
        result = google_provider._get_google_content_from_assistant_conversation_turn(assistant_with_multiple_tools)
    ...
    async def test_get_google_content_from_tool_turn(
        ...
        result = google_provider._get_google_content_from_tool_conversation_turn(tool_response_conversation_turn)
    ...
    async def test_get_google_content_from_multi_tool_turn(
        ...
        result = google_provider._get_google_content_from_tool_conversation_turn(multi_tool_response_conversation_turn)
    ...
    async def test_get_google_content_from_conversation_turns_empty(
        ...
        result = await google_provider._get_google_content_from_conversation_turns(empty_conversation_turns)
    ...
    async def test_get_google_content_from_conversation_turns_single_user(
        ...
        result = await google_provider._get_google_content_from_conversation_turns(single_user_turn)
    ...
    async def test_get_google_content_from_conversation_turns_complex(
        ...
        result = await google_provider._get_google_content_from_conversation_turns(complex_unified_conversation_turns)
    ...
    async def test_get_google_content_from_conversation_turns_performance(
        ...
        result = await google_provider._get_google_content_from_conversation_turns(large_conversation_flow)
        end_time = time.time()
...
class TestGoogleStreamingResponse:
    ...
    async def test_parse_streaming_response_basic(
        ...
        result = await google_provider._parse_streaming_response(
            mock_google_streaming_response, stream_id="test_stream_123", session_id=456
        )
    ...
    async def test_parse_streaming_response_with_function_call(
        ...
        result = await google_provider._parse_streaming_response(mock_google_streaming_with_function_call)
    ...
    async def test_parse_streaming_response_malformed(
        ...
        result = await google_provider._parse_streaming_response(mock_google_streaming_malformed)
