...
from test.fixtures.backend_common.services.chunking.rerankers.handler.llm_based.reranker_fixtures import (
    ...
    none_llm_response,
    denotation_list_basic,
    denotation_list_empty,
    denotation_list_non_existent,
    denotation_list_mixed,
    mock_render_snippet_array,
    session_id,
    different_session_id,
    mock_app_logger,
    mock_asyncio_sleep,
    mock_time_perf_counter,
    llm_based_chunk_reranker,
    combined_chunks_basic,
    combined_chunks_large,
)
...
class TestLLMBasedChunkRerankerGetChunksFromDenotation:
    ...
    def test_get_chunks_from_denotation_basic_match(
        ...
        result = LLMBasedChunkReranker.get_chunks_from_denotation(
            combined_chunks_basic, denotation_list_basic
        )
    ...
    def test_get_chunks_from_denotation_empty_chunks(
        ...
        result = LLMBasedChunkReranker.get_chunks_from_denotation(
            empty_chunks, denotation_list_basic
        )
    ...
    def test_get_chunks_from_denotation_empty_denotations(
        ...
        result = LLMBasedChunkReranker.get_chunks_from_denotation(
            combined_chunks_basic, denotation_list_empty
        )
    ...
    def test_get_chunks_from_denotation_no_matches(
        ...
        result = LLMBasedChunkReranker.get_chunks_from_denotation(
            combined_chunks_basic, denotation_list_non_existent
        )
    ...
    def test_get_chunks_from_denotation_partial_matches(
        ...
        result = LLMBasedChunkReranker.get_chunks_from_denotation(
            combined_chunks_basic, denotation_list_mixed
        )
    ...
    def test_get_chunks_from_denotation_duplicate_denotations(
        ...
        result = LLMBasedChunkReranker.get_chunks_from_denotation(
            combined_chunks_basic, denotations
        )
    ...
    def test_get_chunks_from_denotation_maintains_order(
        self,
        combined_chunks_basic,
        mock_chunk_info_class
    ) -> None:
    ...
    def test_get_chunks_from_denotation_large_dataset(
        self,
        combined_chunks_large,
        mock_chunk_info_class
    ) -> None:
        ...
        result = LLMBasedChunkReranker.get_chunks_from_denotation(
            combined_chunks_large, denotations
        )
        end_time = time.time()
    ...
    def test_get_chunks_from_denotation_case_sensitivity(
        self,
        combined_chunks_basic,
        mock_chunk_info_class
    ) -> None:
...
class TestLLMBasedChunkRerankerRerank:
    ...
    async def test_rerank_successful_basic(
        ...
        with patch('app.backend_common.services.chunking.rerankers.handler.llm_based.reranker.LLMHandler') as mock_llm_handler_class, \
             patch('app.backend_common.services.chunking.rerankers.handler.llm_based.reranker.render_snippet_array') as mock_render, \
             patch('app.backend_common.services.chunking.rerankers.handler.llm_based.reranker.time.perf_counter') as mock_time, \
            ...
            result = await llm_based_chunk_reranker.rerank(
                focus_chunks=sample_focus_chunks,
                related_codebase_chunks=sample_related_chunks,
                query=sample_query
            )
    ...
    async def test_rerank_empty_inputs(
        ...
        with patch('app.backend_common.services.chunking.rerankers.handler.llm_based.reranker.LLMHandler') as mock_llm_handler_class, \
            ...
            result = await llm_based_chunk_reranker.rerank(
                focus_chunks=empty_chunks,
                related_codebase_chunks=empty_chunks,
                query=empty_query
            )
    ...
    async def test_rerank_retry_logic_success_on_second_attempt(
        ...
        with patch('app.backend_common.services.chunking.rerankers.handler.llm_based.reranker.LLMHandler') as mock_llm_handler_class, \
             ...
             patch('app.backend_common.services.chunking.rerankers.handler.llm_based.reranker.time.perf_counter') as mock_time, \
             patch('app.backend_common.services.chunking.rerankers.handler.llm_based.reranker.AppLogger') as mock_logger, \
             patch('app.backend_common.services.chunking.rerankers.handler.llm_based.reranker.asyncio.sleep') as mock_sleep:
            
            mock_handler = MagicMock()
            # First call raises exception, second call succeeds
            mock_handler.start_llm_query = AsyncMock(side_effect=[
