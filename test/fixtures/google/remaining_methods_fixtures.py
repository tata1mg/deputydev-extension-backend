...
def mock_google_llm_payload_complex() -> Dict[str, Any]:
    ...
    function_response_content.parts[
        0
    ].function_response = "def binary_search(arr, target):\n    left, right = 0, len(arr) - 1"
...
def google_payload_with_list_content() -> Dict[str, Any]:
    ...
    function_part.function_response = (
        "test_function response"  # Use string instead of dict for easier string conversion
    )
