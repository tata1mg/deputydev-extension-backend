...
class IdeReviewDataclassFixtures:
    ...
    def get_tool_use_response_data() -> Dict[str, Any]:
        ...
        return {
            ...
            "response": {"results": ["result1", "result2"], "total": 2},
        }
    ...
    def get_tool_use_response_with_complex_data() -> Dict[str, Any]:
        ...
        return {
            ...
            "response": {
                ...
                "summary": {"total_files": 1, "total_issues": 2, "high_severity": 1, "medium_severity": 1},
                "metadata": {"analyzed_at": "2023-01-01T12:00:00Z", "analyzer_version": "1.0.0"},
            },
        }
    ...
    def get_agent_request_item_data() -> Dict[str, Any]:
        ...
        return {"agent_id": 1, "review_id": 123, "type": RequestType.QUERY}
    ...
    def get_multi_agent_review_request_data() -> Dict[str, Any]:
        ...
        return {
            "agents": [
                {"agent_id": 1, "review_id": 123, "type": RequestType.QUERY},
                {"agent_id": 2, "review_id": 123, "type": RequestType.TOOL_USE_RESPONSE},
            ],
            "review_id": 123,
    ...
    def get_agent_task_result_data() -> Dict[str, Any]:
        ...
        return {
            ...
            "agent_type": "security",
            "status": "success",
            "result": {"comments": ["Security issue found"], "confidence": 0.85},
        }
    ...
    def get_minimal_agent_task_result_data() -> Dict[str, Any]:
        ...
        return {"agent_id": 3, "agent_name": "minimal_agent", "agent_type": "general", "status": "error", "result": {}}
    ...
    def get_file_wise_changes_data() -> Dict[str, Any]:
        ...
        return {
            ...
            "file_name": "main.py",
            "status": "modified",
            "line_changes": {"added": 10, "removed": 5, "modified": 8},
            "diff": "@@ -1,5 +1,7 @@\n def hello():\n-    print('Hello')\n+    print('Hello World')\n+    return True",
        }
    ...
    def get_comment_update_request_data() -> Dict[str, Any]:
        ...
        return {"id": 123, "comment_status": IdeReviewCommentStatus.ACCEPTED}

    @staticmethod
    def get_repo_id_request_data() -> Dict[str, Any]:
        """Return valid repo ID request data."""
        return {"repo_name": "test_repository", "origin_url": "https://github.com/organization/test_repository.git"}
    ...
    def get_various_request_types() -> List[RequestType]:
        ...
        return [RequestType.QUERY, RequestType.TOOL_USE_RESPONSE, RequestType.TOOL_USE_FAILED]

    @staticmethod
    def get_various_comment_statuses() -> List[IdeReviewCommentStatus]:
        """Return various comment statuses."""
        return [IdeReviewCommentStatus.PENDING, IdeReviewCommentStatus.APPROVED, IdeReviewCommentStatus.DISMISSED]

    @staticmethod
    def get_various_review_types() -> List[ReviewType]:
        """Return various review types."""
        return [ReviewType.FULL_REVIEW, ReviewType.FOCUSED_REVIEW]
    ...
    def get_agent_statuses() -> List[str]:
        ...
        return ["success", "error", "tool_use_request", "pending", "running", "cancelled"]

    @staticmethod
    def get_file_statuses() -> List[str]:
        """Return various file statuses."""
        return ["modified", "added", "deleted", "renamed", "copied"]
