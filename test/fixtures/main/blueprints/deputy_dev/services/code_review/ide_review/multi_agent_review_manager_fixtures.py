...
def sample_agent_request_tool_use_response() -> AgentRequestItem:
    ...
    return AgentRequestItem(
        ...
        payload={
            "tool_response": "File contents: def hello(): pass",
            "session_id": 789
        }
    )
...
def sample_ide_review_response_error() -> Dict[str, Any]:
    ...
    return {
        ...
        "agent_id": 101,
        "data": {
            "message": "Failed to process the review request",
    ...
    return [
        {
            "agent_id": 101,
            "type": "REVIEW_COMPLETE",
            "data": {"comments": ["Comment 1"], "summary": "Success"}
        },
        {
            "agent_id": 102,
            "type": "TOOL_USE_REQUEST",
            "data": {"tool_name": "file_reader", "tool_input": {}}
        },
        {
            "agent_id": 103,
            "type": "REVIEW_ERROR",
            "data": {"message": "Failed to analyze"}
        }
    ]
...
def sample_aws_websocket_manager() -> MultiAgentWebSocketManager:
    ...
    return MultiAgentWebSocketManager(
        connection_id="aws-websocket-conn-xyz789",
        review_id=67890,
        is_local=False
    )
