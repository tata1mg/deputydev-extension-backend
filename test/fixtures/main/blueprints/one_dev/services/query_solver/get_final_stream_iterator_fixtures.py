...
def basic_streaming_response() -> StreamingParsedLLMCallResponse:
    ...
    async def mock_content():
        ...
        yield TextBlockDelta(
            ...
            content=TextBlockDeltaContent(text="Hello ")
        )
        yield TextBlockDelta(
            type=StreamingEventType.TEXT_BLOCK_DELTA,
            content=TextBlockDeltaContent(text="World!")
        )
...
def thinking_streaming_response() -> StreamingParsedLLMCallResponse:
    ...
    async def mock_content():
        yield ThinkingBlockStart(
            type=StreamingContentBlockType.THINKING_BLOCK_START,
...
def code_block_streaming_response() -> StreamingParsedLLMCallResponse:
    ...
    async def mock_content():
        ...
        yield CodeBlockDelta(
            ...
            content=CodeBlockDeltaContent(code_delta="def test():\n")
        )
        yield CodeBlockDelta(
            type=StreamingContentBlockType.CODE_BLOCK_DELTA,
            content=CodeBlockDeltaContent(code_delta="    return True")
        )
        yield CodeBlockEnd(
            type=StreamingContentBlockType.CODE_BLOCK_END,
            content=CodeBlockEndContent(diff="true")
        )
...
def mixed_content_streaming_response() -> StreamingParsedLLMCallResponse:
    ...
    async def mock_content():
        ...
        yield TextBlockDelta(
            type=StreamingEventType.TEXT_BLOCK_DELTA,
            content=TextBlockDeltaContent(text="Let me analyze this...")
        )
        yield TextBlockEnd(type=StreamingEventType.TEXT_BLOCK_END)
        ...
        yield CodeBlockEnd(
            type=StreamingContentBlockType.CODE_BLOCK_END,
            content=CodeBlockEndContent(diff=None)
        )
...
def cancelled_task_streaming_response() -> StreamingParsedLLMCallResponse:
    ...
    async def mock_content():
        ...
        yield TextBlockDelta(
            type=StreamingEventType.TEXT_BLOCK_DELTA,
            content=MagicMock(text="This should not be processed")
        )
...
def mock_thinking_block_with_ignore_chat():
    ...
    start_block = ThinkingBlockStart(
        type=StreamingContentBlockType.THINKING_BLOCK_START,
        ignore_in_chat=True
    )
...
def incomplete_blocks_streaming_response() -> StreamingParsedLLMCallResponse:
    ...
    async def mock_content():
        ...
        yield TextBlockDelta(
            type=StreamingEventType.TEXT_BLOCK_DELTA,
            content=TextBlockDeltaContent(text="Incomplete text...")
        )
