...
def mock_llm_payload() -> Dict[str, Any]:
    ...
    return {
        "conversation_messages": [{"role": "user", "content": [{"type": "input_text", "text": "Hello"}]}],
...
def mock_llm_payload_with_tools() -> Dict[str, Any]:
    ...
    return {
        "conversation_messages": [{"role": "user", "content": [{"type": "input_text", "text": "What's the weather?"}]}],
...
def mock_llm_payload_complex() -> Dict[str, Any]:
    ...
    return {
        ...
        "conversation_messages": [
            {"role": "user", "content": [{"type": "input_text", "text": "How do I implement a binary search?"}]},
...
def empty_llm_payload() -> Dict[str, Any]:
    ...
    return {"system_message": "", "conversation_messages": [], "tools": []}
