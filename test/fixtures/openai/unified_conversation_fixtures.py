        ...
        AssistantConversationTurn(
            content=[
                ...
                UnifiedToolRequestConversationTurnContent(
                    ...
                    tool_input={"location": "detected_location"}
                )
            ]
        ),
            # Tool responses
...
def conversation_with_edge_cases() -> List[UnifiedConversationTurn]:
    ...
    return [
        ...
        UserConversationTurn(
            content=[
                UnifiedTextConversationTurnContent(text="")
            ]
        ),
    ...
    for i in range(50):
        if i % 3 == 0:
            ...
            turns.append(
                UserConversationTurn(
                    content=[
                        UnifiedTextConversationTurnContent(text=f"User message {i+1}")
                    ]
                )
            )
        elif i % 3 == 1: 
