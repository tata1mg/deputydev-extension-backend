...
def attachment_data_task_map_with_image(
    ...
    return {
        sample_image_attachment.attachment_id: mock_task
    }
...
def unified_conversation_turns(
    ...
    return [
        ...
        assistant_tool_request_conversation_turn,
...
def multimodal_unified_conversation_turns(
    ...
    assistant_text_conversation_turn: AssistantConversationTurn
):
...
@pytest.fixture
def minimal_build_payload_args(
