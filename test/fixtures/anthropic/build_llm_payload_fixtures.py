...
def anthropic_attachment_data_task_map_with_image(
    ...
    return {anthropic_sample_image_attachment.attachment_id: mock_task}
...
def anthropic_attachment_data_task_map_multiple(
    ...
    return {1: mock_task1, 2: mock_task2, 3: mock_task3}
...
@pytest.fixture
def anthropic_multiple_tools(
    anthropic_simple_tool: ConversationTool, anthropic_complex_tool: ConversationTool
...
def anthropic_user_conversation_turn_with_cache_breakpoint() -> UserConversationTurn:
    ...
    return UserConversationTurn(
        content=[UnifiedTextConversationTurnContent(text="This message should be cached.")], cache_breakpoint=True
    )
...
def anthropic_multimodal_unified_conversation_turns(
    ...
    return [anthropic_user_multimodal_conversation_turn, anthropic_assistant_text_conversation_turn]
...
def anthropic_minimal_build_payload_args(
    anthropic_sample_llm_model: LLModels, anthropic_empty_attachment_data_task_map: Dict
) -> Dict[str, Any]:
