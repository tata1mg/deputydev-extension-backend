...
from app.main.blueprints.one_dev.services.web_search.prompts.gemini_2_point_5_flash import (
    Gemini2Point5FlashWebSearch,
)


class WebSearchPromptFactory(BaseFeaturePromptFactory):
    web_search_prompts = {
        LLModels.GEMINI_2_POINT_5_FLASH: Gemini2Point5FlashWebSearch,
    }
