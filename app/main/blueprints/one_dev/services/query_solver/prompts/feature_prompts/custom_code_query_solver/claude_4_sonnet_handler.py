...
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.parsers.claude.code_block.claude_4_code_block_parser import (
    Claude4CodeBlockParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.parsers.claude.extended_thinking.claude_4_extended_thinking_parser import (
    Claude4ExtendedThinkingParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.parsers.claude.summary.claude_4_summary_parser import (
    Claude4SummaryParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.parsers.claude.thinking.claude_4_thinking_parser import (
    Claude4ThinkingParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.prompts.claude.claude_4_sonnet_custom_code_query_solver_prompt import (
