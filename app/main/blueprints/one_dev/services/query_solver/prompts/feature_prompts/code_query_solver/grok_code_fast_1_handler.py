...
from deputydev_core.llm_handler.providers.openrouter_models.prompts.base_prompts.base_grok_code_fast_1 import (
...
class GrokCodeFast1CustomCodeQuerySolverPromptHandler(BaseGrokCodeFast1Prompt):
    ...
    async def get_parsed_streaming_events(cls, llm_response: StreamingResponse) -> AsyncIterator[BaseModel]:
        ...
        return cls.parse_streaming_text_block_events(
            ...
            parsers=[GrokCodeFast1CodeBlockParser(), TaskPlanParser()],
            handlers=handlers,
        )
