...
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.prompts.gpt.gpt_5_nano_custom_code_query_solver_prompt import (
