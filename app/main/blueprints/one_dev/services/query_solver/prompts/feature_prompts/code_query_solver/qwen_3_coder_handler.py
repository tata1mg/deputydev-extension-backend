...
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.code_query_solver.prompts.qwen.qwen_3_coder_custom_code_query_solver_prompt import (
    Qwen3CoderCustomQuerySolverPrompt,
)


class Qwen3CoderCustomCodeQuerySolverPromptHandler(BaseOpenrouterModelPromptHandler):
    prompt_type = "CODE_QUERY_SOLVER"
    prompt_category = PromptCategories.CODE_GENERATION.value
    prompt_class = Qwen3CoderCustomQuerySolverPrompt
    ...
    async def get_parsed_streaming_events(cls, llm_response: StreamingResponse) -> AsyncIterator[BaseModel]:
        ...
        return cls.parse_streaming_text_block_events(
            ...
            parsers=[CodeBlockParser(), TaskPlanParser(), ThinkingParser()],
            handlers=handlers,
        )
