...
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.code_query_solver.parsers.openrouter_models.thinking.sonoma_alpha_thinking_parser import (
    SonomaAlphaThinkingParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.code_query_solver.prompts.grok.sonoma_dusk_alpha_custom_code_query_solver_prompt import (
    SonomaDuskAlphaCustomCodeQuerySolverPrompt,
)


class SonomaDuskAlphaCustomCodeQuerySolverPromptHandler(BaseSonomaAlphaPrompt):
    prompt_type = "CODE_QUERY_SOLVER"
    prompt_category = PromptCategories.CODE_GENERATION.value
    model_name = LLModels.OPENROUTER_SONOMA_DUSK_ALPHA
    prompt_class = SonomaDuskAlphaCustomCodeQuerySolverPrompt
    ...
    async def get_parsed_streaming_events(cls, llm_response: StreamingResponse) -> AsyncIterator[BaseModel]:
        return cls.parse_streaming_text_block_events(
            ...
            parsers=[SonomaAlphaCodeBlockParser(), SonomaAlphaThinkingParser()],
        )
