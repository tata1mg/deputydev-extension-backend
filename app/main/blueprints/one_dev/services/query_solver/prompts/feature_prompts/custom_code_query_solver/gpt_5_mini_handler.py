...
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.parsers.openrouter_models.code_block.gpt_5_code_block_parser import (
    Gpt5CodeBlockParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.parsers.openrouter_models.extended_thinking.gpt_5_reasoning_thinking_parser import (
    Gpt5ReasoningThinkingParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.prompts.gpt.gpt_5_mini_custom_code_query_solver_prompt import (
...
class Gpt5MiniCustomCodeQuerySolverPromptHandler(BaseGpt5Prompt):
    prompt_type = "CUSTOM_CODE_QUERY_SOLVER"
    prompt_category = PromptCategories.CODE_GENERATION.value
    prompt_class = Gpt5MiniCustomQuerySolverPrompt
    model_name = LLModels.OPENROUTER_GPT_5_MINI
