...
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.parsers.claude.code_block.claude_3_point_5_code_block_parser import (
    Claude3Point5CodeBlockParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.parsers.claude.summary.claude_3_point_5_summary_parser import (
    Claude3Point5SummaryParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.parsers.claude.thinking.claude_3_point_5_thinking_parser import (
    Claude3Point5ThinkingParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.custom_code_query_solver.prompts.claude.claude_3_point_5_sonnet_custom_code_query_solver_prompt import (
    Claude3Point5CustomCodeQuerySolverPrompt,
)


class Claude3Point5CustomCodeQuerySolverPromptHandler(BaseClaude3Point5SonnetPromptHandler):
    prompt_type = "CUSTOM_CODE_QUERY_SOLVER"
    prompt_category = PromptCategories.CODE_GENERATION.value
    prompt_class = Claude3Point5CustomCodeQuerySolverPrompt
