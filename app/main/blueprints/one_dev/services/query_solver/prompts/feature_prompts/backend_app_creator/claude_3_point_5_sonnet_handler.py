...
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.backend_app_creator.parsers.claude.code_block.claude_3_point_5_code_block_parser import (
    Claude3Point5CodeBlockParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.backend_app_creator.parsers.claude.summary.claude_3_point_5_summary_parser import (
    Claude3Point5SummaryParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.backend_app_creator.parsers.claude.thinking.claude_3_point_5_thinking_parser import (
    Claude3Point5ThinkingParser,
)
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.backend_app_creator.prompts.claude.claude_3_point_5_sonnet_backend_app_creator_prompt import (
    Claude3Point5BackendAppCreatorPrompt,
)


class Claude3Point5BackendAppCreatorPromptHandler(BaseClaude3Point5SonnetPromptHandler):
    prompt_type = "backend_app_creator"
    prompt_category = PromptCategories.CODE_GENERATION.value
    prompt_class = Claude3Point5BackendAppCreatorPrompt
