...
from app.main.blueprints.one_dev.services.query_solver.prompts.feature_prompts.code_query_solver.prompts.gpt.gpt_5_mini_code_query_solver_prompt import (
    Gpt5MiniQuerySolverPrompt,
)


class Gpt5MiniQuerySolverPromptHandler(BaseGpt5Prompt):
    prompt_type = "CODE_QUERY_SOLVER"
    model_name = LLModels.OPENROUTER_GPT_5_MINI
    prompt_category = PromptCategories.CODE_GENERATION.value
    prompt_class = Gpt5MiniQuerySolverPrompt
