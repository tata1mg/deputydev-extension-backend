import asyncio
from typing import AsyncIterator, Dict, Any, Optional, Union, List, Tuple, Callable
...
class StreamHandler(BaseServiceCache):
    ...
    async def _redis_xadd(
        ...
        result = await cls._get_redis_client().execute_command(
            "XADD", stream_key, message_id, *args
        )
        return result
    ...
    @classmethod
    def _parse_stream_message(cls, message_id: str, fields: Dict[str, str], model_class: Optional[type] = None) -> BaseModel:
        """
