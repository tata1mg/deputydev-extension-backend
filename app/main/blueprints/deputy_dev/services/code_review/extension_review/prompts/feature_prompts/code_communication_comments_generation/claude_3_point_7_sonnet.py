...
from app.main.blueprints.deputy_dev.services.code_review.extension_review.prompts.base_prompts.claude_3_point_5_sonnet_comment_creation import BaseClaude3Point5SonnetCommentCreationPrompt
...
class Claude3Point7CodeCommunicationCommentsGenerationPrompt(BaseClaude3Point5SonnetCommentCreationPrompt):
    prompt_type = PromptFeatures.CODE_COMMUNICATION_COMMENTS_GENERATION.value
