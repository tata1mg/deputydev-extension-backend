...
from .claude_3_point_5_sonnet import (
    Claude3Point5CodeMaintainabilityCommentsGenerationPass2Prompt,
)


class CodeMaintainabilityCommentsGenerationPass2PromptFactory(BaseFeaturePromptFactory):
    prompts = {LLModels.CLAUDE_3_POINT_5_SONNET: Claude3Point5CodeMaintainabilityCommentsGenerationPass2Prompt}
