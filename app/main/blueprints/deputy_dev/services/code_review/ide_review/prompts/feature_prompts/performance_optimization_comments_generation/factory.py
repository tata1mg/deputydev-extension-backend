...
from .claude_3_point_7_sonnet import (
    Claude3Point5PerformanceOptimizationCommentsGenerationPrompt,
)


class PerformanceOptimizationCommentsGenerationPromptFactory(BaseFeaturePromptFactory):
    prompts = {
        LLModels.CLAUDE_3_POINT_7_SONNET: Claude3Point5PerformanceOptimizationCommentsGenerationPrompt,
    }
