...
from .claude_3_point_7_sonnet import Claude3Point5ErrorCommentsGenerationPrompt


class ErrorCommentsGenerationPromptFactory(BaseFeaturePromptFactory):
    prompts = {
        LLModels.CLAUDE_3_POINT_7_SONNET: Claude3Point5ErrorCommentsGenerationPrompt,
    }
