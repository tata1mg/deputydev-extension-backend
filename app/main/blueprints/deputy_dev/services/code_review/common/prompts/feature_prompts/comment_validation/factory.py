...
from .gpt_4_point_1 import GPT4Point1CommentValidationPrompt


class CommentValidationPromptFactory(BaseFeaturePromptFactory):
    prompts = {LLModels.GPT_4_POINT_1: GPT4Point1CommentValidationPrompt}
