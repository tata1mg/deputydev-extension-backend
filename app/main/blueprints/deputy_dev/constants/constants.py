...
SETTING_ERROR_MESSAGE = {
    ...
    SettingErrorType.MISSING_KEY.value: f"Invalid override or creation of agents due to missing mandatory keys. Default settings are applied for invalid pre-defined agents, while invalid custom agents are skipped. \n\nInvalid Agents:\n\n",
}
