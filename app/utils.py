    ...
    def wrapped(func):
        async def wrapper(*args):
            try:
                ...
                log_combined_exception('Unable to get response from {}-{} API'.format(service_name, func.__name__), exception,
...
def check_feature_enabled_for_platform(feature_config, client_attributes):
    ...
    """
    operations = {"=": operator.eq, ">=": operator.ge, "<=": operator.le, ">": operator.gt, "<": operator.lt}
