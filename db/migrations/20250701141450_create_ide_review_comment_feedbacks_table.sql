...
CREATE INDEX IF NOT EXISTS idx_ide_review_comment_feedbacks_like ON ide_review_comment_feedbacks(like);
...
DROP INDEX IF EXISTS idx_ide_review_comment_feedbacks_like;
